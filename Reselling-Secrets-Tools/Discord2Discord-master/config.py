...
ENV_TOKENKEYS = os.path.join(ROOT_DIR, "tokenkeys.env")
ENV_DOTENV = os.path.join(ROOT_DIR, ".env")
...
CHANNEL_MAP_PATH: str = os.getenv("CHANNEL_MAP_PATH", os.path.join(ROOT_DIR, "channel_map.json"))
