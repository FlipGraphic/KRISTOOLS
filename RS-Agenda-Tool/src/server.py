...
# Resolve project root and load env from config/
BASE_DIR = os.path.dirname(os.path.dirname(__file__))
load_dotenv(os.path.join(BASE_DIR, "config", "apikeys.env"))
...
# Serve static files relative to project root so /web/Daily.html works
os.chdir(BASE_DIR)

HTTP_TIMEOUT = 12  # seconds

# -------- State --------
STATE_FILE = os.path.join(BASE_DIR, "config", "agenda_data.json")
